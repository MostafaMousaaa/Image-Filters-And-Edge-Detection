...
class MainWindow(QMainWindow):
    ...
    def extractSift(self):
        ...
        #cv2_keypoints, descriptors = sift.detectAndCompute(self.original_image, None)        
        self.current_image = cv2.drawKeypoints(self.current_image, cv2_keypoints, None, color=(0,255,0))
        self.update_image_display()
